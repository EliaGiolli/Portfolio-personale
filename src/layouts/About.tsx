...
function About() {
  ...
  return (
    <>
      <section 
        className="flex flex-col w-full min-h-screen p-2 mb-12 sm:mb-16"
        aria-labelledby='page-title'
        >
        
        <Card 
          variant={CardVariants.profile} 
          className="mb-11 bg-inherit"
          role="region"
          >
          <div className="flex flex-col items-center text-center md:text-left px-8 py-5 grow">
            ...
            <span className={`text-3xl sm:text-5xl font-bold my-4 
              ${isDark ? 'text-tertiary' : 'text-blue-600'}`}
            >
              <ReactTyped
                strings={[
                  "Jr React developer",
        ...
        <Card 
          ...
          <div className="grid col-span-2 px-4">
            ...
            <p className={`text-center text-lg sm:text-2xl p-3 mb-4 
              ${isDark ? 'text-white' : 'text-gray-700'}`}>{t('about.p2')}</p>
